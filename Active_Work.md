...
- [ ] Follow up with Andy, get him to time his current workflow
...
- [ ] Content capture engine v1
- [ ] Tina MCP follow-up
- [ ] Andy Fetch handover
- [ ] Team of Five outline to Rachel (Chamber)
- [ ] Brand voice assistant from 5-day sequence
- [ ] Adult learning theory review
- [ ] Video content direction within engine
...
- [x] Send surveys (Solis)
- [x] Chase Scottie for 1-on-1 (Solis)
- [x] Schedule interviews (Solis)
- [x] Solve technical approach (Solis) ... CoPilot is $800, can't add instructions without losing IP
- [x] Finish remaining content (Engage South)
- [x] Review all copy and check sources (Engage South)
- [x] Deliver (Engage South)
- [x] Re-visit the project (TAA)
- [x] Re-work the playbook (TAA)
- [x] Ask her to delegate (TAA)
- [x] Invoice $750 (TAA)
- [x] Wānaka Chamber outline
- [x] Define 1:1 coaching service offering
- [x] GreenDrinks presentation (write the talk)
- [x] GreenDrinks contact organiser
- [x] Finish Engage content and deliver
- [x] Top 10 create proposal
- [x] Kate and Bridget coaching proposal
- [x] Linzi coaching prep
- [x] DQ proposal
- [x] Turner Hopkins follow up
- [x] Pet Food arrange discovery meeting
